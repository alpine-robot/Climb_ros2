...
cl_arganello_interface__msg__RopeCommand__init(cl_arganello_interface__msg__RopeCommand * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    cl_arganello_interface__msg__RopeCommand__fini(msg);
    return false;
  }
  // rope_force
  // rope_position
...
cl_arganello_interface__msg__RopeCommand__are_equal(const cl_arganello_interface__msg__RopeCommand * lhs, const cl_arganello_interface__msg__RopeCommand * rhs)
{
  ...
  // rope_position
  if (lhs->rope_position != rhs->rope_position) {
    return false;
  }
  // rope_velocity
  ...
  cl_arganello_interface__msg__RopeCommand * output)
{
  ...
  // rope_position
  output->rope_position = input->rope_position;
  // rope_velocity
...
cl_arganello_interface__msg__RopeCommand__create()
{
  ...
  cl_arganello_interface__msg__RopeCommand * msg = (cl_arganello_interface__msg__RopeCommand *)allocator.allocate(sizeof(cl_arganello_interface__msg__RopeCommand), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(cl_arganello_interface__msg__RopeCommand));
  bool success = cl_arganello_interface__msg__RopeCommand__init(msg);
  if (!success) {
...
cl_arganello_interface__msg__RopeCommand__Sequence__init(cl_arganello_interface__msg__RopeCommand__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  cl_arganello_interface__msg__RopeCommand * data = NULL;

  if (size) {
    data = (cl_arganello_interface__msg__RopeCommand *)allocator.zero_allocate(size, sizeof(cl_arganello_interface__msg__RopeCommand), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = cl_arganello_interface__msg__RopeCommand__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        cl_arganello_interface__msg__RopeCommand__fini(&data[i - 1]);
      }
...
cl_arganello_interface__msg__RopeCommand__Sequence__fini(cl_arganello_interface__msg__RopeCommand__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      cl_arganello_interface__msg__RopeCommand__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  cl_arganello_interface__msg__RopeCommand__Sequence * array = (cl_arganello_interface__msg__RopeCommand__Sequence *)allocator.allocate(sizeof(cl_arganello_interface__msg__RopeCommand__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = cl_arganello_interface__msg__RopeCommand__Sequence__init(array, size);
  if (!success) {
...
cl_arganello_interface__msg__RopeCommand__Sequence__destroy(cl_arganello_interface__msg__RopeCommand__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    cl_arganello_interface__msg__RopeCommand__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
cl_arganello_interface__msg__RopeCommand__Sequence__are_equal(const cl_arganello_interface__msg__RopeCommand__Sequence * lhs, const cl_arganello_interface__msg__RopeCommand__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!cl_arganello_interface__msg__RopeCommand__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  cl_arganello_interface__msg__RopeCommand__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(cl_arganello_interface__msg__RopeCommand);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    cl_arganello_interface__msg__RopeCommand * data =
      (cl_arganello_interface__msg__RopeCommand *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!cl_arganello_interface__msg__RopeCommand__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          cl_arganello_interface__msg__RopeCommand__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!cl_arganello_interface__msg__RopeCommand__copy(
