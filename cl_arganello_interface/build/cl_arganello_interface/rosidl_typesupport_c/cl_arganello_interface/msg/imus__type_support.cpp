...
static const _Imus_type_support_symbol_names_t _Imus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cl_arganello_interface, msg, Imus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cl_arganello_interface, msg, Imus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cl_arganello_interface, msg, Imus)() {
  return &::cl_arganello_interface::msg::rosidl_typesupport_c::Imus_message_type_support_handle;
}
